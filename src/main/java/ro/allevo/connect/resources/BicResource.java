...
//	@Path("{payments}")
//	public PaymentsResource payment(@PathParam(value = "payments") String payments) {
//		/* authorizationServer.getAispUrl() */
//		switch (payments) {
//		case "payments":
//		case "periodic-payments":
//			return new PaymentsResource("http://localhost:8080", heders);
//		default:
//			return null;
//		}
//		// PaymentsResource payment = new
//		// PaymentsResource("http://localhost:8080/accounts", heders);
//		// return payment;
//	}
