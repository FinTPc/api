...
import ro.allevo.connect.resources.AuthorizationServersResource;
import ro.allevo.connect.resources.AuthorizationsServersResource;
import ro.allevo.connect.resources.ConsentsResource;
...
//		logger.debug("Exiting ApiResource.()");
	...
	public InternalEntitiesResource getInternalEntities() {
	...
	@Path("reconciliation")
	public ReconciliationResource getReconciliationResource() {
		return new ReconciliationResource(uriInfo, emd);
	}
