 ...
 */
@Entity
@Table(name="txtemplatesconfigdetailed")
@NamedQueries({
	@NamedQuery(name="TxTemplatesConfigDetailedEntity.findAll", query="SELECT t FROM TxTemplatesConfigDetailedEntity t"),
	@NamedQuery(name="TxTemplatesConfigDetailedEntity.findAllByConfigId", query="SELECT t FROM TxTemplatesConfigDetailedEntity t where t.txtemplatesconfig.id=:txtemplatesconfig"),
...
public class TxTemplatesConfigDetailedEntity extends BaseEntity implements Serializable {
	...
	public TxTemplatesConfigDetailedEntity() {
	}
