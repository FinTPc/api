...
public class SampleDataJpaApplication {
	...
	public LocalContainerEntityManagerFactoryBean dataEntityManagerFactory()
		...
		emf.setPackagesToScan("ro.allevo.fintpws.model", "ro.allevo.fintpuiws.model");
	...
	@Primary
	@Bean
	public DataSource dataSourceData() throws IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {
			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSource1 = dataSourceLookup.getDataSource(jndiData);
			return dataSource1;
		} else {
	...
	public LocalContainerEntityManagerFactoryBean cfgEntityManagerFactory()
		...
		// emf.setPackagesToScan("ro.allevo.fintpws.model","ro.allevo.fintpws.converters");
	...
	@Bean
	public DataSource cfgDataSource() throws SQLException, IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {

			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSource1 = dataSourceLookup.getDataSource(jndiCfg);
			return dataSource1;
		} else {
			dataSource.setDriverClassName(driverClassName);
	...
	@Bean
	public DataSource listDataSource() throws SQLException, IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {

			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSource1 = dataSourceLookup.getDataSource(jndiList);
			return dataSource1;
		} else {
			dataSource.setDriverClassName(driverClassName);
	...
	@Bean
	public DataSource trackDataSource() throws SQLException, IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {

			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSource1 = dataSourceLookup.getDataSource(jndiTrack);
			return dataSource1;
		} else {
			dataSource.setDriverClassName(driverClassName);
	...
	public LocalContainerEntityManagerFactoryBean connectEntityManagerFactory()
		...
		emf.setJpaPropertyMap(jpaPropertyMap());
		emf.setPackagesToScan("ro.allevo.connect.model", "ro.allevo.connect.resources");
		final JpaVendorAdapter vendorAdapter = new org.springframework.orm.jpa.vendor.EclipseLinkJpaVendorAdapter();
		emf.setJpaVendorAdapter(vendorAdapter);
		emf.setJpaProperties(jpaProperties());
	...
	@Bean
	public DataSource connectDataSource() throws IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {
			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSourceConnect = dataSourceLookup.getDataSource(jndiConnect);
	...
	public LocalContainerEntityManagerFactoryBean atEntityManagerFactory()
		...
		emf.setJpaPropertyMap(jpaPropertyMap());
		emf.setPackagesToScan("ro.allevo.at.model", "ro.allevo.at.resources"); //, "ro.allevo.at.resources"
		final JpaVendorAdapter vendorAdapter = new org.springframework.orm.jpa.vendor.EclipseLinkJpaVendorAdapter();
		emf.setJpaVendorAdapter(vendorAdapter);
		emf.setJpaProperties(jpaProperties());
	...
	@Bean
	public DataSource atDataSource() throws IllegalArgumentException, NamingException {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		if (standalone.equals("true")) {
			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSourceAt = dataSourceLookup.getDataSource(jndiAt);
			return dataSourceAt;
		} else {
			dataSource.setDriverClassName(driverClassName);
	...
	public DataSource boDataSource() throws IllegalArgumentException, NamingException {
		...
		if (standalone.equals("true")) {
			JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
			DataSource dataSourceBO = dataSourceLookup.getDataSource(jndiBO);
			return dataSourceBO;
		} else {
			dataSource.setDriverClassName(driverClassName);
